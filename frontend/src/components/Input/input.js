...
function InputComponent({variavel, funcaoSetVariavel, icone: Icon = null, sizeIcon = 20,
    placeholder = "", width = "50%", height = "5.5dvh", type = "text", id = null, error = false, ref = "", nomeRef = ""}){
    ...
    return(
        <div className={styles.divInput} style={{width: width, height: height}}>
            ...
            }} id={id} min={type === "number" ? 0 : ""} ref={(elemento) => ref && ref.current ? ref.current[nomeRef] = elemento : ""}
